...
<div class="container">
    ...
    <form:form method="post" action="${contextPath}/organization/${actionPath}" modelAttribute="organization">
        ...
        <div class="mb-3">
            ...
            <form:input type="text" path="companyName" cssClass="form-control"/>
        </div>
        <div class="mb-3">
            <form:label path="yearOfIncorporation">yearOfIncorporation</form:label>
            <form:input type="text" path="yearOfIncorporation" cssClass="form-control" />
        </div>
        <div class="mb-3">
            <form:label path="postalCode">postalCode</form:label>
            <form:input type="text" path="postalCode" cssClass="form-control" />
        </div>
        <div class="mb-3">
            <form:label path="employeeCount">employeeCount</form:label>
            <form:input type="text" path="employeeCount" cssClass="form-control" />
        </div>
        <div class="mb-3">
            <form:label path="slogan">slogan</form:label>
            <form:input type="text" path="slogan" cssClass="form-control"/>
        </div>

        <div class="mb-3">
            <input type="submit" value="save" class="btn btn-primary">
            <input type="button" value="cancel" class="btn" onclick="window.location='${contextPath}/organization/organizations'">
        </div>
    </form:form>
