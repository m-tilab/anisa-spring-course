...
public class OrganizationDaoImpl implements OrganizationDao {
    ...
    public Organization getOrganization(int organizationId) {
        ...
        SqlParameterSource params = new MapSqlParameterSource("organizationId", organizationId);
    ...
    public boolean update(Organization organization) {
        ...
        String sqlQuery = "UPDATE Organization SET companyName = :companyName, yearOfIncorporation = :yearOfIncorporation, " +
                "postalCode = :postalCode, employeeCount = :employeeCount, slogan = :slogan WHERE organizationId = :organizationId";
