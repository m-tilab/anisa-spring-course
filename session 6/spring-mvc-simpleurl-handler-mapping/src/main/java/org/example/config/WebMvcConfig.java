...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    @Bean
    public SimpleUrlHandlerMapping beanNameUrlHandlerMapping() {

        var urlMap = new HashMap<String, Object>();
        urlMap.put("/organization-simpleurl", viewOrganizations());
    ...
    @Bean
    public OrganizationController viewOrganizations() {
